...
const PREFIX_ID = "cms_legal-docs_category";

export const CreateCMSLegalDocsCategoryDisclosure = (props: any) => {
  ...
  const routeTitle = l.settings_navs.cms_master_data.legal_docs_category;
...
export const CreateCMSLegalDocsCategoryDisclosureTrigger = (props: any) => {
  // Props
  ...
  return (
    <>
      ...
      <CreateCMSLegalDocsCategoryDisclosure open={open} />
    </>
  );
};
