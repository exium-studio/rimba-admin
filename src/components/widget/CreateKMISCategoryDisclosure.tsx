...
export const CreateKMISCategoryDisclosure = (props: any) => {
  ...
  const routeTitle = l.private_navs.kmis.category;
...
export const CreateKMISCategoryDisclosureTrigger = (props: any) => {
  // Props
  ...
  return (
    <>
      ...
      <CreateKMISCategoryDisclosure open={open} />
    </>
  );
};
