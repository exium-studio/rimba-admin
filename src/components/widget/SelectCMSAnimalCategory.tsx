...
const SUFFIX_ID = "cms_animal_category";
const ENDPOINT = `/api/cms/public-request/get-all-animal-category`;

export const SelectCMSAnimalCategory = (
  ...
  return (
    <SelectInput
      id={ID}
      title={capitalizeWords(l.animal_cateogry)}
      loading={loading}
