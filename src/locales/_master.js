...
export const msg_signin_title = {
  id: "RIMBA Admin Portal",
  en: "RIMBA Admin Portal",
};
export const msg_signin = {
  id: "Sebelum melanjutkan, silahkan pilih jenis role anda",
  en: "Before proceeding, please select your role",
};
export const msg_signin_as_super_admin = {
  id: "Signin sebagai akun Super Admin",
  en: "Signin as Super Admin account",
};
export const msg_signin_as_monev = {
  id: "Signin sebagai akun Monev",
  en: "Signin as Monev account",
};
export const msg_signin_as_educator = {
  id: "Signin sebagai akun Pengajar",
...
export const alert_signin_super_admin = {
  ...
  description: {
    id: "Anda sedang masuk sebagai Super Admin.",
    en: "You are currently signed in as Super Admin.",
  },
};
...
export const error_invalid_email = {
  title: { id: "Email tidak valid", en: "Invalid email" },
  description: {
