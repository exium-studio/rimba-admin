const translations = {
  ...
  alert_create_package_period_cannot_be_updated_later: {
    ...
    description:
      "Once the package is created, the period cannot be changed. Please make sure it is correct before saving.",
  },
  alert_forbidden: {
    title: "Access denied",
  ...
  msg_export_data_confirmation:
    "An export file will be generated from the current data.",
