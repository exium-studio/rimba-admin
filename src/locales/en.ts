const translations = {
  ...
  "avg_physical_realization": "Average physical realization",
  ...
  "budget_realization": "Budget realization",
  ...
  "current_physical_realization": "Current physical realization",
  "current_physical_target": "Current physical target",
  "dark_mode": "Dark mode",
  ...
  "input_realization_budget_title": "Budget realization based on account",
  "input_realization_physical_title": "Physical realization",
  "january": "January",
  "july": "July",
  "june": "June",
  "language": "Language",
  ...
  "msg_data_below_shown_by_year": "The data below is shown based on year.",
  ...
  "msg_export_data_confirmation": "An export file will be generated from the current data.",
  ...
  "msg_reject_confirmation": "The data will be rejected and not processed.",
  ...
  "msg_signout": "You will be signed out of this session.",
  "msg_soft_delete": "Data will be hidden but can be restored later.",
  "msg_toggle_dark_mode": "Toggle dark mode",
  "msg_validate_confirmation": "The data will be validated and ready to use.",
  ...
  "physical_realization": "Physical realization",
  ...
  "private_navs": {
    "cms": {
      ...
      "animal_composition": "Animal Population",
      "faqs": "FAQs"
    },
    "kmis": {
      "index": "KMIS",
  ...
  "target_and_realization": "Target & realization",
  "theme": "Theme",
  "thursday": "Thursday",
  ...
  "total_user_learning_attempt": "Total learning attempt",
