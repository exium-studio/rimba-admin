const translations = {
  ...
  alert_create_package_period_cannot_be_updated_later: {
    ...
    description:
      "Setelah data paket dibuat, periode tidak dapat diubah. Harap pastikan sudah benar sebelum menyimpan.",
  },
  alert_forbidden: {
    title: "Akses ditolak",
  ...
  error_422_duplicate_question: {
    title: "Data duplikat",
    description:
      "Pertanyaan yang sama di topic tersebut sudah ada, periksa kembali.",
  },
  ...
  expenditure_realization_account:
    "Realisasi anggaran berdasarkan akun belanja",
  ...
  msg_select_material_type_first:
    "Pilih tipe materi terlebih dahulu kemudian input materi.",
